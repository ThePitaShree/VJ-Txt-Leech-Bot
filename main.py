...
async def start(bot: Client, m: Message):
    await m.reply_text(f"<blockquote><b>Hello {m.from_user.mention} 😎</blockquote>\n\n <blockquote>I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File On Telegram So Basically If You Want To Use Me First Send Me /upload Command And Then Follow Few Steps..\n\nUse /stop to stop any ongoing task </blockquote>\n\n <blockquote>Developer: @EL_Pita_Shree</b></blockquote>")
